							...
							<div id="content" role="main">
								...
								<div itemscope itemtype="http://schema.org/Product"
									...
									<div class="summary entry-summary">
										<h1 itemprop="name" class="product_title entry-title">Beige
											Jacket</h1>
									...
									<div class="related products">
										...
										<ul class="products">
											<li class="first product"><a href="shop-single.html">
													<span class="onsale">Sale!</span> <img
											...
											<li class="product last"><a href="shop-single.html">
													<img
